...
const MovieDetailPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-[#303243] from-65% to-[#15151D]  overflow-hidden text-headline">
      ...
      <div className="z-20 relative flex flex-col md:flex-row p-10 lg:p-20 ">
        ...
        <div className="text-headline flex flex-col justify-center w-full md:w-2/3">
          ...
          <p className="mb-4 font-medium text-headline">{movie.overview}</p>
        </div>
      </div>
      <div className="z-20 relative flex flex-col md:flex-row p-10 lg:p-20 md:-mt-12 lg:-mt-28">
        ...
        <div className="flex flex-col w-full md:w-2/3">
          <div className="flex flex-col mb-4">
            <h3 className="text-2xl font-bold text-headline mb-2">Atores</h3>
